...
class HandFaceTracker:
    ...
    def __init__(self):
        ...
        self.display_camera = True  # New variable to control camera display
        self.zoomed = False  # New variable for zoomed state
        self.last_pinky_thumb_state = False  # Track previous state to detect changes
    ...
    def is_point_in_rect(self, point, rect_x, rect_y, rect_w, rect_h):
        ...
        Args:
            ...
            rect_x (int): The x-coordinate of the rectangle's top-left corner.
            rect_y (int): The y-coordinate of the rectangle's top-left corner.
            rect_w (int): The width of the rectangle.
            rect_h (int): The height of the rectangle.
    ...
    def is_point_in_diagonal_zone(self, point, square_x, square_y, square_size, zone_number):
        ...
        Args:
            point (tuple): The point (x, y) to check.
            square_x (int): The x-coordinate of the square's top-left corner.
            square_y (int): The y-coordinate of the square's top-left corner.
            square_size (int): The size of the square.
            zone_number (int): The zone number to check (0 to 3).

        Returns:
            bool: True if the point is inside the specified diagonal zone, False otherwise.
        """
        x, y = point
    ...
    def are_fingers_together(self, landmarks, finger1_tip_id, finger2_tip_id):
        ...
        Args:
            ...
            finger1_tip_id (int): The landmark ID of the first finger tip.
            finger2_tip_id (int): The landmark ID of the second finger tip.

        Returns:
            bool: True if the fingers are together, False otherwise.
        """
        ...
        while self.cap.isOpened():
            ...
            if hand_results.multi_hand_landmarks:
                ...
                for idx, hand_landmarks in enumerate(hand_results.multi_hand_landmarks):
                    ...
                    hand_type = "Left" if handedness == "Right" else "Right"  # Flipped as in your script
            ...
            if face_results.multi_face_landmarks:
                for face_landmarks in face_results.multi_face_landmarks:
                    ...
                    # KEEPING YOUR SQUARE ASSIGNMENT FROM ORIGINAL SCRIPT
                    squares = [
                        # Left square (physically on left, but Right Zone)
                        {
                            ...
                            'name': 'Right Zone',  # As in your code
                            'hand_detected': None
                        },
                        # Right square (physically on right, but Left Zone)
                        {
                            ...
                            'y': int(face_center[1] - square_size/2),
                            'name': 'Left Zone',  # As in your code
                            'hand_detected': None
                        }
                    ]
                    ...
                    if self.display_camera:
                        ...
                        for square in squares:
                            ...
                            # If this is the "LEFT ZONE" (right square in your setup), draw the diagonal divisions
                            if name == 'Left Zone':
                                ...
                                zone_positions = [
                                    (x + square_size//2, y + square_size//4 - 10),  # Top
                                    (x + 3*square_size//4 + 10, y + square_size//2),  # Right
                                    (x + square_size//2, y + 3*square_size//4 + 10),  # Bottom
                                    (x + square_size//4 - 10, y + square_size//2)  # Left
                                ]
